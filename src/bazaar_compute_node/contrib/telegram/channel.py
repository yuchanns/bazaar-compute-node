    ...
    def dm_address(
        ...
        *,
        ...
        return DmAddress(
            ...
            # `sendMessage` reaches a bot this node has never spoken to only by
            # username; a person is not addressable that way at all
        ...
        *,
        ...
        await self._inbound.put(
            Message(
                ...
                channel="telegram",
                provider_thread_id=identity.provider_thread_id,
                provider_chat_id=str(identity.chat_id),
        ...
        await self._inbound.put(
            Message(
                ...
                metadata={
                    ...
                    "threaded": identity.topic_id is not None,
